...
@Mod(modid = LateLoader.MODID, version = LibrarianLib.VERSION, name = LateLoader.MODNAME, dependencies = LateLoader.DEPENDENCIES, modLanguageAdapter = LibrarianLib.ADAPTER)
object LateLoader {
